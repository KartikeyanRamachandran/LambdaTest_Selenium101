...
public class TestScenario03	 extends SeleniumBase {
	...
	public void toDoTestScenario03() {
		...
		String actualResult = driver.findElement(By.xpath("//h2[text()='Input form with validations.']/following::p[@class=\"success-msg hidden\"]")).getText();
